...
const desiredJsonStructure = `{
  ...
  "difficulty": "easy",
  "question": "string (the problem description, The question should be appropriate for introductory python programming courses.)",
